...
public class HebergementDeleteReasonController implements Initializable {
    ...
    private void updateDisplay() {
        if (hebergement != null) {
            String destName = hebergement.getDestination() != null ?
                    hebergement.getDestination().getNom_destination() : "Non spécifiée";

            lblItemInfo.setText("Hébergement: " + hebergement.getNom_hebergement() +
            ...
            String creator = hebergement.getAdded_by_name();
